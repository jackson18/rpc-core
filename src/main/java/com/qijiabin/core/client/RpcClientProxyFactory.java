 ...
 * 修订日期     修订人    描述
 */
public class RpcClientProxyFactory implements FactoryBean<Object>, InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		Class<?> serviceClass = Class.forName(serviceDiscovery.getService());
		proxyClient = PROXY_FACTORY.getProxy(serviceClass, new InvocationHandler() {
            @Override
